...
summary: "A detailed step-by-step tutorial on how to add and get a custom SOAP header using Apache CXF and Spring Boot."
url: /apache-cxf-custom-soap-header-example.html
date: 2017-07-24
lastmod: 2017-07-24
...
When using Maven, add the `&lt;extendedSoapHeaders&gt;` element with a value equals to `'true'` in order to have CXF process the implicit header.
